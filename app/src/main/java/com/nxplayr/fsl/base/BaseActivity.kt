...
import com.nxplayr.fsl.util.LocaleUtils
...
open class BaseActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
     ...
     override fun attachBaseContext(base: Context) {
        ...
        super.attachBaseContext(LocaleUtils.updateConfig(base, MyApplication.langugageName(base)))
    }
