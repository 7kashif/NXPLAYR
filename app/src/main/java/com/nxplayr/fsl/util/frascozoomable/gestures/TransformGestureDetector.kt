package com.nxplayr.fsl.util.frascozoomable.gestures
...
class TransformGestureDetector(private val mDetector: MultiPointerGestureDetector) :
    ...
    val translationX: Float
        get() =
            calcAverage(mDetector.currentX, mDetector.pointerCount) - calcAverage(
                mDetector.startX,
    ...
    val translationY: Float
        get() =
            calcAverage(mDetector.currentY, mDetector.pointerCount) - calcAverage(
                mDetector.startY,
                mDetector.pointerCount
            )
