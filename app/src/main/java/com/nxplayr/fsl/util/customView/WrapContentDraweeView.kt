package com.nxplayr.fsl.util.customView
...
class WrapContentDraweeView : SimpleDraweeView {
    ...
    private val listener: ControllerListener<ImageInfo?> = object : BaseControllerListener<ImageInfo?>() {
    ...
    override fun setImageURI(uri: Uri, callerContext: Any?) {
        val controller: DraweeController = (controllerBuilder as PipelineDraweeControllerBuilder)
