...
class HomeJobListFragment : Fragment(), View.OnClickListener, LifecycleObserver {
    ...
    override fun onCreateView(
        ...
        fragmentHomeJobListBinding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_home_job_list, container, false)
    ...
    private fun setupUI() {
        ...
        if (joblistData == null) {
            ...
            jobListAdapter =
                JobListAdapter(mActivity!!, joblistData, object : JobListAdapter.OnItemClick {
    ...
    private fun getSaveJob(position: Int) {
        ...
        jobListViewModel.getNotificationList(mActivity!!, jsonArray.toString(), "SaveJob")
            .observe(this@HomeJobListFragment, { it ->
    ...
    private fun setupObserver() {
        ...
        jsonArray.put(jsonObject)
        jobListViewModel.getNotificationList(mActivity!!, jsonArray.toString(), "List")
