...
class CurrentClubAdapter(
    ...
    val listData: ArrayList<ClubListData>?
    ...
    class CurrentClubViewHolder(itemView: View, context: Activity) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(listData: ClubListData,
                 adapterPosition: Int,
                 onItemClick: OnItemClick,
                 userId: String) = with(itemView) {


            tv_club_name.text = listData.clubName
            ...
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                clubListFiltered = if (charString.isEmpty()) {
                    ...
                    for (row in listData!!) {
                        ...
                        if (row.clubName.toLowerCase().contains(charString.toLowerCase()) || row.clubName.contains(charSequence)) {
