...
import kotlinx.android.synthetic.main.fragment_business_main.*


class BusinessMainFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
     ...
     //   if (v == null) {
            v = inflater.inflate(R.layout.fragment_business_main, container, false)
       // }
        return v
    }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.tv_job -> {
                ...
                ll_mainViewPager.visibility = View.GONE
                (activity as MainActivity).navigateToBusiness(
                    BusinessSubMainFragment(),
                    BusinessSubMainFragment::class.java.name,
                    true
                )
            }
            R.id.menu_icon -> {
