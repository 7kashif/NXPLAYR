...
class FootballLevelListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context)
            .inflate(com.nxplayr.fsl.R.layout.item_football_level_list, parent, false)
...
//            holder.bind(list_FootballLevel!![position], holder.adapterPosition, onItemClick)
    ...
    class FootballLevelSelectHolder(itemView: View, context: Activity) :
        ...
        fun bind(
            list_footballLevel: FootballLevelData,
            adapterPosition: Int,
            onItemClick: OnItemClick,
            footballLevelId: String
        ) = with(itemView) {
            ...
            if ((list_footballLevel.isSelect)) {
                ...
                tv_football_level.setCompoundDrawablesWithIntrinsicBounds(
                    0,
                    0,
                    R.drawable.tick_black,
                    0
                )
//                select_level.visibility = View.VISIBLE
            } else {
                ll_layout.background = resources.getDrawable(R.drawable.rounded_edittext_primary)
