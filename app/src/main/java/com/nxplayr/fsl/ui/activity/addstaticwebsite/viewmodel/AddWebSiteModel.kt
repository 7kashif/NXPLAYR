...
class AddWebSiteModel:ViewModel(){
    ...
    var getWebsiteAddResponse: LiveData<List<WebsitePojo>>?=null
    var mContext: Activity?=null
    var isShowing: Boolean = false
    var json: String = ""
    var from=""

    fun apiAddSubAlbum(context: Activity, isShowing: Boolean,
                          json: String): LiveData<List<WebsitePojo>> {
        this.mContext = context
        this.isShowing = isShowing
        this.json = json

        getWebsiteAddResponse = apiSubAlbumDeleteResponse()
        return getWebsiteAddResponse!!
    }
