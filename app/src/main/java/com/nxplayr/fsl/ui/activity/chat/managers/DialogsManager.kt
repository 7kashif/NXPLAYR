...
import com.nxplayr.fsl.ui.activity.chat.utils.chat.CURRENT_PAGE_BUNDLE_PARAM
import com.nxplayr.fsl.ui.activity.chat.utils.chat.ChatHelper
import com.nxplayr.fsl.ui.activity.chat.utils.chat.TOTAL_PAGES_BUNDLE_PARAM
import com.nxplayr.fsl.ui.activity.chat.utils.chat.USERS_PER_PAGE
...
import com.nxplayr.fsl.ui.activity.chat.utils.qb.getOccupantsIdsStringFromList
import com.nxplayr.fsl.ui.activity.chat.utils.qb.getOccupantsNamesStringFromList
...
class DialogsManager {
    ...
    private fun buildMessageCreatedGroupDialog(dialog: QBChatDialog): QBChatMessage {
        ...
        qbChatMessage.body = MyApplication.instance.getString(R.string.new_chat_created, getCurrentUserName())
    ...
    private fun buildMessageAddedUsers(dialog: QBChatDialog, userIds: String, usersNames: String): QBChatMessage {
        ...
        qbChatMessage.body = MyApplication.instance.getString(R.string.occupant_added, getCurrentUserName(), usersNames)
        qbChatMessage.setSaveToHistory(true)
        qbChatMessage.isMarkable = true
        return qbChatMessage
    }
    ...
    private fun buildMessageLeftUser(dialog: QBChatDialog): QBChatMessage {
        ...
        qbChatMessage.body = MyApplication.instance.getString(R.string.occupant_left, getCurrentUserName())
        qbChatMessage.setSaveToHistory(true)
        qbChatMessage.isMarkable = true
        return qbChatMessage
    }
