...
class ParentInfoActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setupUI() {
        ...
        setUI()
        MyUtils.setSelectedModeTypeViewColor(this, arrayListOf(introduce_your_parents, textinput_parent_info_email, emailAddress_edit_text, mobile_textInputLayout, mobile_edit_text) as ArrayList<View>, colorId!!)
        ...
        mobile_edit_text.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if (loginType) {
                    ...
                    mobile_edit_text.setPadding(resources.getDimensionPixelOffset(R.dimen._60sdp), resources.getDimensionPixelOffset(R.dimen._25sdp), resources.getDimensionPixelOffset(R.dimen._1sdp), resources.getDimensionPixelOffset(R.dimen._10sdp))
                    ...
                    mobile_edit_text.setPadding(resources.getDimensionPixelOffset(R.dimen._10sdp), resources.getDimensionPixelOffset(R.dimen._25sdp), resources.getDimensionPixelOffset(R.dimen._1sdp), resources.getDimensionPixelOffset(R.dimen._10sdp))
    ...
    private fun setupViewModel() {
         countryListModel = ViewModelProvider(this@ParentInfoActivity).get(CountryListModel::class.java)
    ...
    private fun chekValidation() {
        ...
        when {
            mobile_edit_text!!.text.toString().trim().isEmpty() -> {
                ...
                MyUtils.showSnackbar(this@ParentInfoActivity, getString(R.string.please_enter_mobile_number), ll_main_parents)
            }
            mobile_edit_text.text.toString().trim().length < 8 || mobile_edit_text.text.toString().trim().length > 16 -> {

                MyUtils.showSnackbar(this@ParentInfoActivity, getString(R.string.please_enter_valid_mobile_number), ll_main_parents)
            }
            emailAddress_edit_text!!.text.toString().trim().isEmpty() -> {
                MyUtils.showSnackbar(this@ParentInfoActivity, getString(R.string.please_enter_email_id), ll_main_parents)
            }
            (!MyUtils.isValidEmail(emailAddress_edit_text.text.toString().trim())) -> {
                MyUtils.showSnackbar(this@ParentInfoActivity, resources.getString(R.string.valid_email_address), ll_main_parents)
            }
            else -> {
                signUp()
            }
