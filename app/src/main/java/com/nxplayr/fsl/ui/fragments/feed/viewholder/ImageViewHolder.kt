 ...
 */
class ImageViewHolder(itemView: View?, var context: Activity) : RecyclerView.ViewHolder(itemView!!)
{
    ...
    init {
        ...
        postprocessor= BlurPostprocessor(context, 35,10)
        ...
        trendingItemPhotoAdapter= TrendingItemPhotoAdapter(context)
