package com.nxplayr.fsl.ui.fragments.adapter
...
import com.nxplayr.fsl.util.frascozoomable.zoomable.DoubleTapGestureListener
import com.nxplayr.fsl.util.frascozoomable.zoomable.ZoomableDraweeView
...
*/
        ...
        view.controller = Fresco.newDraweeControllerBuilder()
            .setUri(Uri.parse(RestClient.image_base_url_posts + albummedia[position].albummediaFile))
            .build()
