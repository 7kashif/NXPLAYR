...
class HomeMainFragment : Fragment(), View.OnClickListener {
    ...
    private val tabIcons = intArrayOf(
        ...
        R.drawable.home_activity_unselected_,
        R.drawable.home_chat_unselected_,
        R.drawable.home_news_unselecte_,
        R.drawable.home_notification_unselected_
    )
    ...
    override fun onCreateView(
     ...
     //   if (v == null) {
            v = inflater.inflate(R.layout.fragment_comment_main, container, false)
       // }
        return v
    }
...
//    }
    ...
    private fun initView() {
        ...
        setupTabIcons()
        tabLayout_home.getTabAt(tab_position)?.icon?.setColorFilter(Color.parseColor("#00F0FF"), PorterDuff.Mode.SRC_IN)
...
//        tabLayout_home.getTabAt(4)?.setIcon(tabIcons[4])
    ...
    private fun setupViewPager(viewPager: ViewPager) {
       if (adapter == null) {
            ...
            adapter?.addFragment(HomeFeedListFragment(), "")
