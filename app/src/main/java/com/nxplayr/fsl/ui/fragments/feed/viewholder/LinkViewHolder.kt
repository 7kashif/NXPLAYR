...
import kotlinx.android.synthetic.main.item_feed_list.view.btnLike
import kotlinx.android.synthetic.main.item_feed_list.view.btn_chat
import kotlinx.android.synthetic.main.item_feed_list.view.btn_more
import kotlinx.android.synthetic.main.item_feed_list.view.btn_share
import kotlinx.android.synthetic.main.item_feed_list.view.btn_views
import kotlinx.android.synthetic.main.item_feed_list.view.edit_post_comment
import kotlinx.android.synthetic.main.item_feed_list.view.emoji
import kotlinx.android.synthetic.main.item_feed_list.view.feed_userImg
import kotlinx.android.synthetic.main.item_feed_list.view.homePhotoVideoTime
import kotlinx.android.synthetic.main.item_feed_list.view.homeUserProfession
import kotlinx.android.synthetic.main.item_feed_list.view.img_like
import kotlinx.android.synthetic.main.item_feed_list.view.layout_share
import kotlinx.android.synthetic.main.item_feed_list.view.ll_comment
import kotlinx.android.synthetic.main.item_feed_list.view.ll_comment_list
import kotlinx.android.synthetic.main.item_feed_list.view.ll_like
import kotlinx.android.synthetic.main.item_feed_list.view.ll_more
import kotlinx.android.synthetic.main.item_feed_list.view.ll_view
import kotlinx.android.synthetic.main.item_feed_list.view.recyclerview_comment
import kotlinx.android.synthetic.main.item_feed_list.view.tv_chat_count
import kotlinx.android.synthetic.main.item_feed_list.view.tv_details
import kotlinx.android.synthetic.main.item_feed_list.view.tv_like_count
import kotlinx.android.synthetic.main.item_feed_list.view.tv_name
import kotlinx.android.synthetic.main.item_feed_list.view.tv_share
import kotlinx.android.synthetic.main.item_feed_list.view.tv_views_count
import kotlinx.android.synthetic.main.item_feed_list.view.userImage

/**
 * Created by dhavalkaka on 12/02/2018.
 */
class LinkViewHolder(itemView: View?, var context: Activity) : RecyclerView.ViewHolder(itemView!!)
{
    ...
    var trendingItemPhotoAdapter: TrendingItemLinkAdapter? = null
    ...
    init {
        ...
        /*   target = object : Target {
           override fun onBitmapLoaded(bitmap: Bitmap?, from: LoadedFrom?) {
               blurImage?.setImageBitmap(BlurImage.fastblur(bitmap!!, 1f, 50))
            }
            override fun onBitmapFailed(e: Exception?, errorDrawable: Drawable?) {
                blurImage?.setImageResource(R.mipmap.ic_launcher)
            }
        ...
        trendingItemPhotoAdapter= TrendingItemLinkAdapter(context)
